...
public class PossiblePathsInATree {
    ...
    private static int union(int a, int b, int[] parent, int[] sz) {
    ...
    public static ArrayList<Integer> maximumWeight(int n, int[][] edges, int q, int[] queries) {
        ...
        for (int i = 0; i < n - 1; i++) wt.add(new int[]{edges[i][2], edges[i][0], edges[i][1]});
        wt.sort(Comparator.comparingInt(a -> a[0]));
